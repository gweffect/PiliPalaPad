...
import 'package:PiliPalaPad/pages/msg_feed_top/at_me/view.dart';
import 'package:PiliPalaPad/pages/msg_feed_top/reply_me/view.dart';
import 'package:PiliPalaPad/pages/msg_feed_top/like_me/view.dart';
import 'package:PiliPalaPad/pages/follow_search/view.dart';
import 'package:PiliPalaPad/pages/setting/pages/logs.dart';
...
class Routes {
  static final List<GetPage<dynamic>> getPages = [
    ...
    //账号页面
    CustomGetPage(name: '/user', page: () => const UserPage()),
  ];
}
